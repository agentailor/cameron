...
| What                          | URL                                 |
| ----------------------------- | ----------------------------------- |
| Interactive explorer (Scalar) | `http://localhost:3100/api-docs`    |
| Raw OpenAPI 3.1 JSON          | `http://localhost:3100/api/openapi` |
...
```bash
curl http://localhost:3100/api/openapi -o openapi.json
