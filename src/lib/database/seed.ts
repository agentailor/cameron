...
const SAMPLE: SeedTxn[] = [
  { daysAgo: 2, amount: 12.5, type: TransactionType.expense, note: "Morning coffee", category: "Dining", account: Account.CHECKING, merchant: "Blue Bottle" },
  { daysAgo: 3, amount: 84.32, type: TransactionType.expense, note: "Weekly groceries", category: "Groceries", account: Account.CHECKING, merchant: "Whole Foods" },
  { daysAgo: 5, amount: 40.0, type: TransactionType.expense, note: "Gas fill-up", category: "Transport", account: Account.CREDIT, merchant: "Shell" },
  { daysAgo: 7, amount: 15.99, type: TransactionType.expense, note: "Streaming subscription", category: "Entertainment", account: Account.CREDIT, merchant: "Netflix" },
  { daysAgo: 12, amount: 120.0, type: TransactionType.expense, note: "Electricity bill", category: "Utilities", account: Account.CHECKING, merchant: "PG&E" },
  { daysAgo: 15, amount: 2500.0, type: TransactionType.income, note: "Paycheck", category: "Income", account: Account.CHECKING, merchant: "Employer" },
  { daysAgo: 20, amount: 9.75, type: TransactionType.expense, note: "Lunch", category: "Dining", account: Account.CHECKING, merchant: "Chipotle" },
  { daysAgo: 25, amount: 62.4, type: TransactionType.expense, note: "Grocery run", category: "Groceries", account: Account.CHECKING, merchant: "Trader Joe's" },
  { daysAgo: 34, amount: 28.0, type: TransactionType.expense, note: "Ride share", category: "Transport", account: Account.CREDIT, merchant: "Uber" },
  { daysAgo: 45, amount: 2500.0, type: TransactionType.income, note: "Paycheck", category: "Income", account: Account.CHECKING, merchant: "Employer" },
];
