  ...
  transaction: {
    ...
    columns: [
      { name: "id", type: "text", nullable: false, note: "primary key" },
      {
        ...
        type: "timestamp",
        nullable: false,
        note: "when it happened — use for date filters/grouping",
      },
      {
        name: "amount_minor",
        type: "integer",
        nullable: false,
        note: "ALWAYS POSITIVE, minor units (cents). Divide by 100.0 to display. Direction is `type`, NOT the sign.",
      },
      ...
      { name: "merchant", type: "text", nullable: true },
      {
        ...
        type: "text",
        nullable: true,
        note: "FK -> category.id; NULL = uncategorized",
      },
      { name: "account", type: "enum('CHECKING','SAVINGS','CREDIT','CASH')", nullable: false },
      {
        ...
        type: "text",
        nullable: false,
        note: "provenance: 'manual' | 'csv' | 'demobank'",
      },
      { name: "external_id", type: "text", nullable: true, note: "source-native id" },
      {
        ...
        type: "timestamp",
        nullable: false,
        note: "row insert time — usually prefer occurred_at",
      },
